<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action([\App\Http\Controllers\SongsControllerController::class, 'store']), 'method' => 'post', 'id' => 'song_form' ]); ?>


    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title"><?php echo app('translator')->get( 'songs.add_song' ); ?></h4>
    </div>
    ...
    <div class="modal-body">
      <div class="form-group">
        <?php echo Form::label('name', __( 'song.song_name' ) . ':*'); ?>
          ...
          <?php echo Form::text('song_name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'song.song_name' )]); ?>
          ...
          <span class="input-group-addon">
              ...
              <select id="routeSelect"  class="form-control accounts-dropdown select2" name="routeSelect"  required>
                <?php $__currentLoopData = $routeNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $routeName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($routeName, false); ?>"><?php echo e(str_replace(['.', '_', '-'], ' ', $routeName), false); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
      </div>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\xampp\htdocs\pos\resources\views/songs/create.blade.php ENDPATH**/ ?>