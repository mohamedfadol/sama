...
<section class="content no-print">
	...
	<div class="row">
		<div class="col-md-12 text-center">
			<button type="button" id="submit_purchase_return_form" class="btn btn-primary btn-big btn-flat"><?php echo app('translator')->get('messages.submit'); ?></button>
		</div>
	</div>
	<?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/purchase_return/create.blade.php ENDPATH**/ ?>