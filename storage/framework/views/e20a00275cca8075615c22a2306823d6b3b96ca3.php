...
<div class="row">
	...
	<div class="col-md-4">
		...
		<h5><?php echo e(__('lang_v1.select_invoice_layout'), false); ?></h5>
				<?php $__currentLoopData = $invoice_layouts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<input name="invoice_layout_id[]" value="<?php echo e($key, false); ?>" type="checkbox" id="invoice<?php echo e($key, false); ?>"/><label for="invoice<?php echo e($key, false); ?>"> <?php echo e($invoice, false); ?> </label>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>


		<!-- <?php echo Form::select('invoice_layout_id', $invoice_layouts, $default_location->invoice_layout_id, ['class' => 'form-control select2', 'placeholder' => __('lang_v1.select_invoice_layout'), 'id' => 'invoice_layout_id']); ?> -->
		</div>
	</div>
	<?php endif; ?>
...
</div><?php /**PATH C:\xampp\htdocs\ferasnew\stableSam\resources\views/sale_pos/partials/pos_form.blade.php ENDPATH**/ ?>