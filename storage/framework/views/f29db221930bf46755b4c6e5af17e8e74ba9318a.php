    ...
    <div class="row">
        <div class="col-md-12 text-right mb-12" >
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(action([\App\Http\Controllers\SellController::class, 'index']), false); ?>" class="btn btn-success no-print btn-sm" ><i class="fas fa-backward"></i>
                </a>
            <?php endif; ?>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pos\resources\views/sale_pos/partials/show_invoice.blade.php ENDPATH**/ ?>