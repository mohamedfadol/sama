            ...
            <div class="col-sm-3">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<?php echo Form::text('journal_date', \Carbon::createFromTimestamp(strtotime($journal->operation_date))->format(session('business.date_format') . ' ' . 'H:i'), ['class' => 'form-control datetimepicker', 'readonly', 'required']); ?>
